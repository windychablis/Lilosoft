package com.chablis.lilosoft.activity.route;
...
public class BusRouteDetailActivity extends Activity implements OnMapLoadedListener,
	...
	private void init() {
		...
		String dur = MapUtils.getFriendlyTime((int) mBuspath.getDuration());
		String dis = MapUtils.getFriendlyLength((int) mBuspath.getDistance());
