package com.chablis.repair.widget;
...
public class ImageManagerView extends RecyclerView {
    ...
    public ImageManagerView(Context context) {
        super(context);
        init(context, null);
    }

    public ImageManagerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ImageManagerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CHImageBox);
        mLeftMargin = a.getDimensionPixelSize(R.styleable.CHImageBox_ch_left_margin, 0);
        mRightMargin = a.getDimensionPixelSize(R.styleable.CHImageBox_ch_right_margin, 0);
        mMaxLine = a.getInteger(R.styleable.CHImageBox_ch_max_line, DEFAULT_MAX_LINE);
        mImageSize = a.getInteger(R.styleable.CHImageBox_ch_img_size_one_line, DEFAULT_IMAGE_SIZE);
        mPadding = a.getDimensionPixelSize(R.styleable.CHImageBox_ch_img_padding, DEFAULT_IMAGE_PADDING);
        mDefaultPicId = a.getResourceId(R.styleable.CHImageBox_ch_img_default, -1);
        mDeletePicId = a.getResourceId(R.styleable.CHImageBox_ch_img_delete, -1);
        mAddPicId = a.getResourceId(R.styleable.CHImageBox_ch_img_add, -1);
        mDeletable = a.getBoolean(R.styleable.CHImageBox_ch_img_deletable, DEFAULT_DELETABLE);
        a.recycle();
    ...
    private static class MyAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = mInflater.inflate(R.layout.ch_image_box_item, parent, false);
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            if (holder.getAdapterPosition() == getItemCount() - 1 && !lastOne) {
                ...
                holder.ivPic.setImageResource(addPic == -1 ? R.mipmap.iv_add : addPic);
                ...
                holder.ivDelete.setImageResource(deletePic == -1 ? R.mipmap.iv_delete : deletePic);
